...
### Step 1 (Home Page)
In this step the user selects the Preferred Currency* and Enters the Amount** He/She wishes to pay.

* - Currency is a required Field.
** - Amount is a required Field and it cannot be more than 100.
